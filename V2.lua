--[[
    FISCH ULTIMATE V3 (FIXED)
    - Fix Black Screen (Rendering)
    - Fix Minimize/Exit Logic
    - Custom Smooth Dragging (Mobile Friendly)
]]
...
-- ====================================================
-- 3. CUSTOM DRAGGING SCRIPT (MOBILE FIX)
-- ====================================================
...
-- 4. GUI CONSTRUCTION
-- ====================================================
if CoreGui:FindFirstChild("FischFixApp") then CoreGui.FischFixApp:Destroy() end

local ScreenGui = Instance.new("ScreenGui"); ScreenGui.Name = "FischFixApp"; ScreenGui.Parent = CoreGui
...
-- [[ MAIN FRAME ]]
local Main = Instance.new("Frame"); Main.Size = UDim2.new(0, 320, 0, 300); Main.Position = UDim2.new(0.5, -160, 0.5, -150)
...
local Title = Instance.new("TextLabel"); Title.Text = "FISCH ULTIMATE V3"; Title.Size = UDim2.new(0.6, 0, 1, 0); Title.Position = UDim2.new(0.05, 0, 0, 0)
...
-- Sidebar
local Sidebar = Instance.new("Frame"); Sidebar.Size = UDim2.new(0, 80, 1, -35); Sidebar.Position = UDim2.new(0, 0, 0, 35)
Sidebar.BackgroundColor3 = Color3.fromRGB(15, 16, 20); Sidebar.BorderSizePixel = 0; Sidebar.Parent = Main
Instance.new("UICorner", Sidebar)

-- Container
local Container = Instance.new("Frame"); Container.Size = UDim2.new(1, -90, 1, -45); Container.Position = UDim2.new(0, 85, 0, 40)
...
local function CreateTab(y, txt, pName)
    ...
    b.Text = txt; b.BackgroundColor3 = Color3.fromRGB(30, 32, 38); b.TextColor3 = Color3.fromRGB(200, 200, 200)
    b.Font = Enum.Font.GothamBold; b.TextSize = 10; b.Parent = Sidebar; Instance.new("UICorner", b)
    b.MouseButton1Click:Connect(function()
        FishingPage.Visible = (pName == "Fish")
        ShopPage.Visible = (pName == "Shop")
    end)
end
CreateTab(10, "FISHING", "Fish")
CreateTab(50, "SHOP", "Shop")

-- ====================================================
-- 6. CONTENT LOAD (SIMPLIFIED FOR PERFORMANCE)
-- ====================================================
...
local farmBtn = Instance.new("TextButton"); farmBtn.Size = UDim2.new(0.8, 0, 0, 35); farmBtn.Position = UDim2.new(0.1, 0, 0, 130); farmBtn.Text = "START FISHING"; farmBtn.BackgroundColor3 = Color3.fromRGB(0, 150, 100); farmBtn.TextColor3 = Color3.fromRGB(255, 255, 255); farmBtn.Font = Enum.Font.GothamBlack; farmBtn.Parent = FishingPage; Instance.new("UICorner", farmBtn)

-- Farming Logic
farmBtn.MouseButton1Click:Connect(function()
    Settings.IsFarming = not Settings.IsFarming
    farmBtn.Text = Settings.IsFarming and "STOP" or "START"
...
local buyBtn = Instance.new("TextButton"); buyBtn.Size = UDim2.new(0.8, 0, 0, 30); buyBtn.Position = UDim2.new(0.1, 0, 0, 50); buyBtn.Text = "BUY ONE"; buyBtn.BackgroundColor3 = Color3.fromRGB(0, 100, 200); buyBtn.TextColor3 = Color3.fromRGB(255, 255, 255); buyBtn.Parent = ShopPage; Instance.new("UICorner", buyBtn)
